    ...
    <div className="App">
      <main className="App-main">
        <div className="container">
          ...
          <h3>A project by <a href="http://rensvis.nl/">Rens Vis</a></h3>
          <p>
        ...
        <div className="container card">
          ...
          <p>
            This is (clearly) a <i className="fab fa-react react-logo"></i> <span className="bold">React</span> project. The project consists of the following different components:
          </p>
          <ul>
          ...
          <p>The jokes are pulled in via this <span className="bold">api</span>: <a href="https://jokeapi.dev/">joke api</a>.</p>

          <p>
            Check out the full <span className="bold">sourcecode</span> on <a href="https://github.com/rensvis/react-joke-bot"><i className="fab fa-github"></i> GitHub</a>.
          </p>
        </div>

        <div className="container footer">
          <p>- 2021 <a href="http://rensvis.nl/">Rens Vis</a> -</p>
        </div>
      </main>
      <ModalOverlay
