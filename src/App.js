...
function App() {
  ...
  return ( <
    ...
    /h3> <
    p >
    Welcome to the React Joke Bot.Press the button in the bottom right of the page to have a laugh!
    <
    /p> <
    /div> <
    ...
    h4 > Description < /h4> <
    p >
    The chat shows the user predefined phrases to choose from and the bot answers in a conversational context. <
    /p>

    <
    h4 > Under the hood < /h4> <
    p >
    This is a < i className = "fab fa-react react-logo" > < /i>{" "} <
    ...
    /div> <
    /main> <
    ModalOverlay classModalOverlay = {
      isChatExpanded ? "modal-overlay--is-visible" : ""
    }
    onClickOverlay = {
      toggleChatVisibility
    }
    /> <
    ChatBox onToggleChatVisibility = {
      toggleChatVisibility
    }
    isChatExpanded = {
      isChatExpanded
